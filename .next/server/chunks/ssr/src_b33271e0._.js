...
"[project]/src/app/(dashboard)/estimate/data:63492c [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(dashboard)/estimate/data:fab3df [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$estimate$2f$data$3a$63492c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(dashboard)/estimate/data:63492c [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$estimate$2f$data$3a$fab3df__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(dashboard)/estimate/data:fab3df [app-ssr] (ecmascript) <text/javascript>");
...
function EstimatePage() {
    ...
    const handleConversationalSubmit = async (content)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$estimate$2f$data$3a$fab3df__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getConversationalResponse"])(newHistory, collectedData);
            setMessages((prev)=>[
                    ...prev,
                    {
                        role: 'model',
            ...
            if (result.isComplete && result.updatedData) {
                ...
                const finalResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$estimate$2f$data$3a$63492c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEstimate"])(fullData);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (view === 'chat' && messages.length === 0) {
            ...
            async function startConversation() {
                try {
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$estimate$2f$data$3a$fab3df__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getConversationalResponse"])([], {});
                    setMessages([
                        {
                            role: 'model',
                            content: result.response
    ...
    async function onFormSubmit(values) {
        ...
        setEstimate(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$estimate$2f$data$3a$63492c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEstimate"])(values);
            setEstimate(result);
        } catch (error) {
            toast({
                variant: 'destructive',
...
//# sourceMappingURL=src_b33271e0._.js.map